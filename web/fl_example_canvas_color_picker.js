...
app.registerExtension({
    name: "Fill.ExampleCanvasColorPicker",
    async nodeCreated(node) {
        if (node.comfyClass === "FLExampleCanvasColorPicker") {
            const PADDING = 10;
            ...
            if (!colorWidget) {
                console.error("FLExampleCanvasColorPicker: Could not find 'selected_color' widget!");
                return;
            }
